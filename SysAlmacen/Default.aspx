<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SysAlmacen.Default" %>
                                ...
                                <form id="form1" action="#" class="row justify-content-center" runat="server">
                                    <div>
                                        <div class="form-group col-12">
                                            <asp:TextBox ID="txtUsuario" type="text" placeholder="Usuario" class="form-control" runat="server"></asp:TextBox>
                                        </div>

                                        <div class="form-group col-12">
                                            <asp:TextBox ID="txtContraseña" type="password" placeholder="Contraseña" class="form-control" runat="server"></asp:TextBox>
                                        </div>
